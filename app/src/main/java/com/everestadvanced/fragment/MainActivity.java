...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    //here you must remember you are in activity so using getSupportFragmentManager()
    //but you are in fragment not access getSupportFragmentManager() that time use FragmentManager()
